...
function g23GameTimerCountdown() {
...
function g23UpdateGameTimer() {
  ...
  if (g23GameTimeLeft <= 0) {
    ...
    g23GameTimeLeft--;
    g23GameTimerCountdown();
  }
}

function g23QnATimerCountdown() {
  g23QnATimer = window.setTimeout('g23UpdateQnATimer()',1000);
}

function g23UpdateQnATimer() {
...
function g23getRandomQnA() {
  while (g23roundDone < 10) {
    ...
    if (g23doNotUseQnA.indexOf(i) === -1) {
      g23doNotUseQnA[g23roundDone] = i;
      g23QnA = g23AllQnA[i];
      g23createArea();
      g23CurrentQnA = document.createElement('span');
      g23CurrentQnA.textContent = ' Q' + (i + 1);
      return g23QnA;
    }
  }
}

function g23createArea() {

  g23A1div = document.createElement('div');
  g23A1div.id = 'g23A1';
  g23A1div.classList.add('text-light','bg-primary','border','border-primary','rounded','m-1','p-3');
  g23A1div.textContent = g23QnA[1];

  g23A2div = document.createElement('div');
  g23A2div.id = 'g23A2';
  g23A2div.classList.add('text-light','bg-primary','border','border-primary','rounded','m-1','p-3');
  g23A2div.textContent = g23QnA[2];

  g23A3div = document.createElement('div');
  g23A3div.id = 'g23A3';
  g23A3div.classList.add('text-light','bg-primary','border','border-primary','rounded','m-1','p-3')
  g23A3div.textContent = g23QnA[3];

  g23A4div = document.createElement('div');
  g23A4div.id = 'g23A4';
  g23A4div.classList.add('text-light','bg-primary','border','border-primary','rounded','m-1','p-3')
